...
protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
    ...
    switch(route) {
        case "add" -> {
            ...
            float calificacion = (Float.parseFloat(req.getParameter("calificacion"))/20);
            int anio = Integer.parseInt(req.getParameter("anio"));
            float estrellas = (Float.parseFloat(req.getParameter("calificacion"))/20);
            ...
            try {
                ...
                res.sendRedirect("pages/administradorPelis.html");
                ...
                res.setContentType("application/json; charset=UTF-8");
                Map<String, String> response = new HashMap<>();
                response.put("message", "Error al guardar la película: " + e.getMessage());
                mapper.writeValue(res.getWriter(), response);
            }
        }
    }
